...
describe TwilioApi do
  ...
  it 'sends an SMS' do
    ...
    messager.should_receive(:create).with({:from => '+441704450128', :to => '+447748299962', :body => 'hello ruben'})

    twilio = TwilioApi.new
    twilio.stub(:messenger).and_return(messager)
    twilio.send_sms('+447748299962', 'hello ruben')
  end

  it 'receives an SMS' do
    messager = double(:messager)
    messager.should_receive(:get).with('SM53b2c779a2c7c2b914e50744ce2efe36')
